...
export default function Footer() {
  return (
    <footer className="text-gray-400  shadow-2xl shadow-fuchsia-900 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">
          © {(/\d{4}/.exec(Date())[0])} Muhammad Daniyal —
          <a
        ...
        <a className="text-gray-400 transition ease-in-out delay-0  hover:-translate-y-1 hover:scale-110"
                  ...
                  {/* <a className="ml-2 text-gray-400 transition ease-in-out delay-0  hover:-translate-y-1 hover:scale-110"
                  ...
                  {/* <a className="ml-3 text-gray-400 transition ease-in-out delay-0  hover:-translate-y-1 hover:scale-110"
                  ...
                  <a
                    className="ml-4 text-gray-400 transition ease-in-out delay-0  hover:-translate-y-1 hover:scale-110 "
                    target="_blank"
